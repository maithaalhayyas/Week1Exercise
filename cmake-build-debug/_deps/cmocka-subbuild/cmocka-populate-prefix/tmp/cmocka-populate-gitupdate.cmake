...
execute_process(
  COMMAND "/usr/local/bin/git" show-ref cmocka-1.1.5
  WORKING_DIRECTORY "/Users/maithaalhayyas/Desktop/Week1Exercise/cmake-build-debug/_deps/cmocka-src"
...
# yet).
execute_process(
  COMMAND "/usr/local/bin/git" rev-list --max-count=1 cmocka-1.1.5
  WORKING_DIRECTORY "/Users/maithaalhayyas/Desktop/Week1Exercise/cmake-build-debug/_deps/cmocka-src"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: '/Users/maithaalhayyas/Desktop/Week1Exercise/cmake-build-debug/_deps/cmocka-src/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: '/Users/maithaalhayyas/Desktop/Week1Exercise/cmake-build-debug/_deps/cmocka-src/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
